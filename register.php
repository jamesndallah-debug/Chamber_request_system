...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
	...
	if ($username === '' || $password === '' || $fullname === '' || $department === '' || $role_id === 0) {
		...
		if ($exists->fetchColumn()) {
			...
			$stmt = $pdo->prepare('INSERT INTO users (username, password, fullname, department, role_id) VALUES (?, ?, ?, ?, ?)');
	...
	<div class="auth-container">
		<div class="welcome-section">
			...
			<div class="welcome-content">
				...
				<p style="margin-top: 15px; font-size: 0.95rem; opacity: 0.9; line-height: 1.5;">To facilitate private sector development in Tanzania by providing exceptional value to members and entire business community through the provision of demand-driven services using highly competent staff and modern technologies.</p>
			</div>
		</div>
		...
		<div class="register-section">
			...
			<form method="POST">
				...
				<button type="button" class="other-signup-btn" onclick="signUpWithGoogle()">
