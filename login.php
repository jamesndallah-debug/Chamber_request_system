...
<body>
            ...
            <form action="index.php?action=login" method="POST">
                <div class="form-group">
                    ...
                    <input 
                        ...
                        name="username" 
                        class="form-input" 
                        placeholder="email@example.com or +255..." 
    ...
    <script>
        ...
        function simulateGoogleLogin() {
            // For demo/development - simulate successful Google login
            ...
            .catch(error => {
                ...
                alert('Demo mode: Google sign-in simulation');
            });
        }
